...
const OrderDetail = (): JSX.Element => {
  ...
  const signatureContent = useRef<any>()
  const signatureContentDocument = useRef<any>()
        ...
        <CRow>
            ...
            <CCard className="mt-4 px-0">
              ...
              >
                ...
                <PrintDownloadButtons
                  ...
                  signatureContent={signatureContentDocument}
                />
              </CCardBody>
            </CCard>
          ) : (
          ...
          <CCard className="mt-4 px-0">
            ...
            >
              ...
              <PrintDownloadButtons contentRef={commentRef} />
            </CCardBody>
          </CCard>
          {/* PROTOCOL CARD */}
